...
<body >
    <form id="form1" runat="server" class="styleThese" autocomplete="off" action="">
                ...
                <asp:UpdatePanel ID="upLogin" runat="server">
                    <ContentTemplate>
                        <div class="login-cont">
                            ...
                            <asp:TextBox ID="txtUser" runat="server" MaxLength="32" CssClass="up-login" ToolTip="Username"  autocomplete="false" ></asp:TextBox>
                        <asp:TextBoxWatermarkExtender ID="weUserID" runat="server" TargetControlID="txtUser"
                            ...
                            <asp:TextBox ID="txtPassword" runat="server" ToolTip="Password is case sensitive."
                                MaxLength="25" CssClass="watermarkcss" TextMode="Password" placeholder="Password"  autocomplete="false" ></asp:TextBox>
