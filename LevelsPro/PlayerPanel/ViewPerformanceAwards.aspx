<%@ Page Title="" Language="C#" MasterPageFile="~/PlayerPanel/Player.master" AutoEventWireup="true" CodeBehind="ViewPerformanceAwards.aspx.cs" Inherits="LevelsPro.PlayerPanel.ViewPerformanceAwards" %>
            ...
            <div class="box brd mt10 m10px p10px">
                ...
                <div class="green-wrapper fl maw m10px">
                    <asp:Button ID="Button2" runat="server" Text="<%$ Resources:TestSiteResources, Levels %> "
                        PostBackUrl="~/PlayerPanel/ViewLevelAwards.aspx" class="green"></asp:Button>
                </div>
                <div class="orange-wrapper fl maw m10px">
                    <asp:Button ID="Button3" runat="server" Text="<%$ Resources:TestSiteResources, Performance %> "
                        PostBackUrl="~/PlayerPanel/ViewPerformanceAwards.aspx" class="orange"></asp:Button>
                </div>
                <div class="green-wrapper fl maw m10px">
