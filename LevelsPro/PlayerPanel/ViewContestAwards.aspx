<%@ Page Title="" Language="C#" MasterPageFile="~/PlayerPanel/Player.master" AutoEventWireup="true" CodeBehind="ViewContestAwards.aspx.cs" Inherits="LevelsPro.PlayerPanel.ViewContestAwards" %>
            ...
            <div class="box brd mt10 m10px p10px">
                ...
                <div class="orange-wrapper fl maw m10px">
                    <asp:Button ID="Button4" runat="server" Text="<%$ Resources:TestSiteResources, Contest %> "
                        PostBackUrl="~/PlayerPanel/ViewContestAwards.aspx" class="orange"></asp:Button>
                </div>
                <div class="clear">
                </div>
            </div>
