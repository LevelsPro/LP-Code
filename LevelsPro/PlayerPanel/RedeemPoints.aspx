                ...
                <div class="body-cont">
                    ...
                    <div class="redemption-holder redemption">
                        <div class="viewport redemption">
                            <div style="width: 100px; position: absolute; top: -50px; height: 100px; right: -50px;">
                            </div>
                            <div style="width: 100px; position: absolute; bottom: -50px; height: 100px; right: -50px;">
                            </div>
                            <div class="overview">
                                        ...
                                        <div class="red-cont box">
                                            ...
                                            <div class="desc">
                                                ...
                                                <div class="btn-holder">
                                                    <asp:LinkButton ID="lbtnRedeem" runat="server" Font-Overline="false" OnClientClick='<%# Eval("Reward_Name", "return confirm(\"Are you sure you want to redeem the {0}.\");") %>'
                                                        CommandName="redeem" CommandArgument='<%# Eval("Reward_Cost") %>'>
                                                        <div class="rdmption-btn" id="divscore" runat="server">
                                                            ...
                                                            <asp:Label ID="lblRedeem" runat="server" Font-Size="X-Large" CssClass="amount" Font-Bold="true"
                                                                ForeColor="Black" Text='<%# Eval("Reward_Cost") %>'></asp:Label>
